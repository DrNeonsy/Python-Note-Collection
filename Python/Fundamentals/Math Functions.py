...
print(math.ceil(7.000000001))  # This Will Round The Number "Up" To The Next Integer

print(
    math.floor(7.999999999999999)
...
print(max(1, 2, 3, 4, 5))  # Returns The Highest Value Of A Collection Of Numbers
